...
;;
;; Preconditions
;;   start-state must be a vaild state for problem
;;   heuristic must take states from this problem
;;
;; Postconditions
...
;;modified the copied code from uniform-cost-search by Jerod Weinman
